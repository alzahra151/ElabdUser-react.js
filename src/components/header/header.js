...
const Header = () => {
  ...
  const showDropdown1 = (e, id, i) => {
    axios.get(`https://elabdapi-eg.onrender.com/api/elabdfoods/Categorie/${id}`)
  ...
  const searchData = (vlu) => {
    console.log(vlu);
    axios.get(`https://elabdapi-eg.onrender.com/api/elabdfoods/Product?EnName=${vlu}`)
      .then(function (response) {
        // handle success
...
//   const [localvlu, setlocalvlu] = useState(JSON.parse(localStorage.getItem('items')))
  ...
  useEffect(() => {
    ...
    axios.get('https://elabdapi-eg.onrender.com/api/elabdfoods/Categorie')
      .then(function (response) {
        // handle success
        console.log(response.data);
      ...
      axios({  
        ...
        url: "https://elabdapi-eg.onrender.com/api/elabdfoods/Cart",
        method: "GET",
        headers: {
