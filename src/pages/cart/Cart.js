...
console.log(checkbox);
  ...
  function decrease (price){
   ...
   function deleteHandler(id){
    console.log(id)
    axios({method:"delete",url: `https://elabdapi-eg.onrender.com/api/elabdfoods/Cart/${id}`},{headers:{'Content-Type': 'application/json',token:"token "+localStorage.getItem('myAccessToken')}})
    .then((res) => {
       console.log(posts)
    console.log(res)
    })
